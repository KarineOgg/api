package com.apirest.api.resources.exceptions;
...
class ResourceExceptionHandlerTest {
    ...
    @DisplayName("deve retornar uma excecao objectNotFound quando o obj nao for encontrado")
    @Test
    void testarObjectNotFoundException() {
    ...
    @DisplayName("deve retornar uma excecao dataIntegrityViolationException")
    @Test
